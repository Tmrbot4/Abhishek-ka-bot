...
BOT_TOKEN = environ.get('BOT_TOKEN', "7087054574:AAGaMnvM762qnqUNYohb3If1e-IF2Tc_1ko")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))
PICS = (environ.get('PICS', 'https://graph.org/file/499fd76473078bc2e11a8.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/499fd76473078bc2e11a8.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/499fd76473078bc2e11a8.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002216021341'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6401293878').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002235457347').split()]
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/notytube41')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/notytube41')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+jVNw2kLMnwQyZmU1') # Support Chat Link Without https:// or @
